...
- Workbench is the sole schema owner (migration 013); memory is an INSERT-only writer pinned to a documented column contract (ADR 0058).
...
18. **API typing:** → Keep bare dicts + hand-written TS interfaces (no `response_model`). [ADR 0059]
