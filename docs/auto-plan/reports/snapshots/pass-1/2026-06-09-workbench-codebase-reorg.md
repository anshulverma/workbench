...
1. `git mv auth.py runtime/auth.py`, `git mv middleware.py runtime/middleware.py`.
...
- No `workbench.models`, `workbench.metrics`, `workbench.memory`, `workbench.main`, `workbench.registry`, `workbench.redaction`, `workbench.auth`, `workbench.middleware`, `workbench.config_writer`, `workbench.alerting`, `workbench.privacy`, `workbench.instrumentation`, `workbench.logging`, `workbench.usage_aggregator` references remain anywhere.
