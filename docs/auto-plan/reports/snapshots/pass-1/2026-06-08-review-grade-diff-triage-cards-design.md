...
ADRs already written (one decision area each): `docs/adr/0022-typed-card-content-in-dict.md`, `0023-presenter-renders-chat-ui-renders-json.md`, `0024-diff-fetch-lazy-in-enricher.md`, `0025-per-source-card-content-generator.md`, `0026-cardmessage-structured-messenger-interface.md`, `0027-triage-interaction-stays-text-replies.md`, `0028-css-only-hunk-rendering.md`, `0029-presentation-config-restart-only-v1.md`. (Renumbered from 0021–0028 because `0021-stable-source-id` was created concurrently.)
