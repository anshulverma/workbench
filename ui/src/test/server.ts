...
const CORRECTIONS: ServerCorrection[] = [
  {
    ...
    rule_id: 1,
    filter_id: '1',
    item_summary: 'CI notification: build passed',
  ...
  },
  {
    ...
    rule_id: null,
    filter_id: null,
    item_summary: 'Random notification',
...
const TUNING_TASKS: ServerTuningTask[] = [
  ...
  },
  {
    ...
    filter_id: '2',
    item_id: 2,
    item_summary: 'Diff about team work',
    from_outcome: 'include',
    to_outcome: 'drop',
    from_label: 'Include',
    to_label: 'Drop',
    filter_prompt: 'Include any diff mentioning my team',
  ...
  return [
    ...
    http.post('/api/feedback/tasks', async ({ request }) => {
      ...
      const created: ServerTuningTask = {
        ...
        item_summary: body.item_summary ?? null,
        from_outcome: body.from_outcome ?? null,
        to_outcome: body.to_outcome ?? null,
        from_label: body.from_label ?? null,
        to_label: body.to_label ?? null,
        filter_prompt: body.filter_prompt ?? null,
